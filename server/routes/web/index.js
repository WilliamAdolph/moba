module.exports = app => {
  ...
  router.get('/news/init',async(req,res) => {
    ...
    const cats = await Category.find().where({
      parent: parent
    }).lean()  //lean()表示取纯粹的json，js的对象和数组
    const newsTitles  = ["新皮肤爆料丨大秦宣太后优化进度曝光，玩趣恶龙惊现峡谷~", "星元皮肤爆料 | 小乔百变泳装，测测你最适合哪一款！", "【大神问答】donny、猫神、孤影、小潘潘降临微社区，教你如何玩转星辰之子-曜", "庆全球注册破2亿，QQ飞车手游登录送绝版赛车！", "美术优化 | 多款模型品质升级，可爱不减，细节满分！", "7月12日全服不停机更新公告", "【稷下星之队】建议更新版本上架公告", "助力世冠奖金池 领千万大回馈活动今日开启", "7月9日全服不停机更新公告", "心愿单升级完毕 部分大区开放功能体验", "首款世冠专属皮肤明日0点开售 有助力回馈福利即将开启", "迎王者荣耀世界冠军杯 参与活动赢惊喜好礼", "稷下精彩活动明日到来 任你徜徉王者峡谷", "稷下星之队集结 新版本超值福利回馈", "【曜眼星辰 为你点亮】活动公告", "王者荣耀世界冠军杯荣耀来袭，KPL赛区选拔赛谁能突围而出？", "【关于2019年KPL春季赛总决赛门票退换及异地用户现场观赛补贴公告】", "KCC小组赛快讯：RW.Yguo武则天52.1%输出占比助RW侠夺世冠首胜", "世冠课代表：小组赛第三日比赛", "世冠淘汰赛：7月27日吉隆坡开战，门票今日12:00开售"]
    ...
    await Article.deleteMany({})  // 以任意的条件去查询并删除
  ...
  router.get('/news/list', async(req,res) => {
    ...
    // 这里是修改名字，如果是热门就选择第一个categories的分类名，如果不是就根据名字来，新闻的就改成新闻的，公告的就改成公告的
    cats.map(cat => {
